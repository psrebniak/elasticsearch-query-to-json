...
var SearchQuery = /** @class */ (function () {
    function SearchQuery(client, options) {
        this.client = client;
        this.options = options;
        this.scrollIds = [];
        this.progress = 0;
    }
    SearchQuery.prototype.process = function (handler) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        if (!(search.hits.total > this.progress)) return [3 /*break*/, 4];
    ...
    SearchQuery.prototype.cleanUp = function () {
...
(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                writer = args.output ? (new FileJsonArrayWriter(args.output)) : (new StdoutJsonArrayWriter());
                query = new SearchQuery(client, {
                    index: args.index,
                    scroll: args.scroll,
                    size: args.size,
                    body: args.query
